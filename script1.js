    ...
    const questions = [
      {
        ...
        imageUrl: 'gambar/singa.jpg',
        options: ['Ikan', 'Monyet', 'Singa'],
        answer: 'Singa',
        explanation: 'Ini adalah Singa Sang Raja Hutan.',
      },
      {
        question: 'Apa Nama Hewan Ini?',
        imageUrl: 'gambar/jerapah.jpg',
        options: ['Jerapah', 'Kancil', 'Zebra'],
        answer: 'Jerapah',
        explanation: 'Ini adalah Jerapah Hewan dengan Leher Terpanjang.',
      }
